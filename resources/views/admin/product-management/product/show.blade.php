...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card row">
                    <div class="card-header col-12 text-center"  style="background-color: #4f46e5;">
                        <h4 class="card-title text-white font-weight-bold ">Review</h4>
                    </div>
                    <div class="card-body">
                        <dl class="row">
                            <div class="col-4">
