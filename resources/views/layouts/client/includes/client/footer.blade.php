  ...
  <footer class="bg-white">
      ...
      <div class="row py-4">
        ...
        <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
          ...
          <ul class="list-unstyled mb-0">
            <li class="mb-2"><a href="#" class="text-muted">For Cat</a></li>
            <li class="mb-2"><a href="#" class="text-muted">For Dog</a></li>
    ...
    <div class="bg-light py-4">
      <div class="container text-center">
        <p class="text-muted mb-0 py-2">© 2021 Petme E-commerce All rights reserved.</p>
      </div>
    </div>
  </footer>
  <!-- End -->
