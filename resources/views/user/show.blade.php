    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            /* background: url('https://wallpaperaccess.com/full/1447306.jpg'); */
        }
...
<body>
    ...
    <!--Content-->
    <div class="container mt-100 mb-100 border-2" style="">
        <div>
            <div class="row">
                <div class="col-4">
                    <div class="row">
                ...
                <div class="col-8 bg-white mt-sm-5">
                    <h3 class="pb-4 font-weight-bold">Personal Information</h3>
                    ...
                    <div class="row h6">
                        <div class="col-md-2 border-bottom-1 mt-3 mb-3  font-weight-bold"  >
                            First Name :
                        </div>
                        ...
                        <div class="col-md-4 border-bottom-1 mt-3 mb-3 font-weight-bold" >
                            Phone Number :
                        </div>
                    ...
                    <h3 class="pb-4 font-weight-bold">Address</h3>
