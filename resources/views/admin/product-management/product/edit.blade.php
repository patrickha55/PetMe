        ...
        <div class="container-fluid">
            <div class="w-full bg-white rounded shadow-lg p-8 m-4l">
                <h2 class="text-center">
                    Update <span class="font-medium">Product #{{ $product->id }}</span> of Category <span class="font-medium">{{ $product->productCategory->animalCategory->name }}</span>
                </h2>
                <form class="row g-3" action="{{ route('product.update', $product) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('description') border-red-500 @enderror" name="description" id="description" rows="3" >{{ $product->description }}</textarea>
                        @error('description')
                        <div class="text-sm text-danger mt-2">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('ingredient') border-red-500 @enderror" name="ingredient" id="ingredient" rows="3">{{ $product->detail->ingredients }}</textarea>
                        @error('ingredient')
                        <div class="text-sm text-danger mt-2">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('material') border-red-500 @enderror" name="material" id="material" rows="3">{{ $product->detail->materials }}</textarea>
                        @error('material')
                        <div class="text-sm text-danger mt-2">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('instruction') border-red-500 @enderror" name="instruction" id="instruction" rows="3">{{ $product->detail->instruction }}</textarea>
                        @error('instruction')
                        <div class="text-sm text-danger mt-2">
                            {{ $message }}
                        </div>
